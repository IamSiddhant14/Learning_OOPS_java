...
public class Main{
    ...
    public static void main( String[] args){// Here this " String[] args "represent that it is an array of string named as args 
        ...
        // 1.> Here this method "main" is also static in nature as we dont require to create an object of the class "Main" in order to invoke the "main" method thats why it is been made as public in nature
        ...
        //Notes : Any data type which could not be broken into other data types are called premitive data type like( stavk mai he refrence variable banta hai) :
        ...
        //Wrapper classes : Stack mai reference variable banta hai or uska object heap mai banta hai jis ko refernce variable point karta hai
...
//         String s = scn.next();
// //      System.out.println("Hello World : "+ args[0]); To run this:             java   Main.java "Siddhant"
...
Student s = new Student();// Allocating a variable at run time and returns a refrence to it
